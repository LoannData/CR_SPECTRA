...
import os 
import shutil 
sys.path.append(base_pos+'./tools/')
...
###############################################################################
# !!! Do not modify this part !!! #
shutil.copy(base_pos+"./data_analysis/show_data.py", nml.total_path+"/data_analysis/") 
shutil.copy(base_pos+"./data_analysis/pcr_ip_2D.py", nml.total_path+"/data_analysis/") 

shutil.copy(base_pos+"./tools/freader.py", nml.total_path+"/tools/") 
shutil.copy(base_pos+"./tools/constants.py", nml.total_path+"/tools/") 

shutil.copy(base_pos+"./namelist.py", nml.total_path+"/tools/")
shutil.copy(base_pos+"./setup.py", nml.total_path+"/tools/")


shutil.copy(base_pos+"./src/constants.h", nml.total_path+"/tools/")
