...
{
    return tesc(E, ni, X)/injection_function_width;           // Corresponds approximately to the width of the escape time divided
}
...
double Finj(double t, double dt, double E, double ni, double X)
{
    ...
    double time_max = t_end_injection*tesc(E, ni, X) - time_min;
