...
for ii in range(len(E)) : 
    ...
    K_zz_HII_1[ii] = Kappa_zz(E[ii], ism.HII, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 1.5, I = 1e-4)
    K_zz_WIM_1[ii] = Kappa_zz(E[ii], ism.WIM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 1.5, I = 1e-4)
    K_zz_WNM_1[ii] = Kappa_zz(E[ii], ism.WNM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 1.5, I = 1e-4)
    K_zz_CNM_1[ii] = Kappa_zz(E[ii], ism.CNM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 1.5, I = 1e-4)
    K_zz_DiM_1[ii] = Kappa_zz(E[ii], ism.DiM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 1.5, I = 1e-4)
    K_zz_DeM_1[ii] = Kappa_zz(E[ii], ism.DeM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 1.5, I = 1e-4)
    K_zz_DeC_1[ii] = Kappa_zz(E[ii], ism.DeC, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 1.5, I = 1e-4)
    
    K_zz_HII_2[ii] = Kappa_zz(E[ii], ism.HII, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 5./3, I = 1e-4)
    K_zz_WIM_2[ii] = Kappa_zz(E[ii], ism.WIM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 5./3, I = 1e-4)
    K_zz_WNM_2[ii] = Kappa_zz(E[ii], ism.WNM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 5./3, I = 1e-4)
    K_zz_CNM_2[ii] = Kappa_zz(E[ii], ism.CNM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 5./3, I = 1e-4)
    K_zz_DiM_2[ii] = Kappa_zz(E[ii], ism.DiM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 5./3, I = 1e-4)
    K_zz_DeM_2[ii] = Kappa_zz(E[ii], ism.DeM, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 5./3, I = 1e-4)
    K_zz_DeC_2[ii] = Kappa_zz(E[ii], ism.DeC, mass = cst.mp, kmin = (50*cst.pc)**(-1), q = 5./3, I = 1e-4)
